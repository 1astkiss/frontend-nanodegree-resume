...
var work = {};
work.position = "Founder";
work.employer = "Fixlab Korea";
work.yearsWorked = 2;

var project ={};
project["lastSchoolAttended"] = "INSEAD";
project["yearsAttended"] = 5;
project["schoolCity"] = "Fontainedbleu, France";

console.log(work.yearsWorked);
$("#topContacts").append(work.position).append(project.lastSchoolAttended);

var education = {
	"schools":[
		{
			"name" : "INSEAD",
			"city" : "Fontainedbleu, France",
			"major" : "MBA",
			"gradYear" : 2005
		},
